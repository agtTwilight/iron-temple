...
export const Team = () => {
	...
	const testData = [
		...
		},
		{
			...
			about: `You may have seen Lindsay leading the team of spotters and loaders for Washington State Powerlifting meets, or maybe even saw her give you a red light while competing.`,
			about2: `Lindsay has been powerlifting for about 9 years. She loves everything about powerlifting - from the community to the volunteering. 
