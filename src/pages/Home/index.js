...
import eleikoBarIPF from '../../assets/images/eleiko-bar-ipf.jpg';
			...
			<Container id="home-content">
				<Row>
					...
					<Col>
						<Carousel fade>
							<CarouselItem>
								<img className="carousel-img-home" src={eleikoPlates} alt="25 kilogram calibrated weight on a weight tree."></img>
							</CarouselItem>
							<CarouselItem>
								<img className="carousel-img-home" src={eleikoRack} alt="Side view image of the Eleiko combo rack."></img>
							</CarouselItem>
							<CarouselItem>
								<img className="carousel-img-home" src={eleikoBar} alt="Image of the barbell barrel."></img>
							</CarouselItem>
							<CarouselItem>
								<img className="carousel-img-home" src={eleikoBench} alt="Image of the bench pad on the Eleiko combo rack."></img>
							</CarouselItem>
						</Carousel>
					</Col>
				</Row>
